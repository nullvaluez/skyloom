...
export const AIRCRAFT_TYPE_NAMES = {
  ...
  // --- Round 15: modern corpus gap-fill ---------------------------------
  // Audited against a live adsb.lol sample (the round-15 fix was CLASSIFICATION
  // lying, but the card also has to NAME what it classifies). Only designators
  // we could confirm are listed — an unconfirmed code is better rendered raw
  // than confidently wrong. Existing entries above are untouched.

  // Cessna singles / light twins the base list skipped
  ...
  F406: 'Reims F406 Caravan II',

  // Piper
  P28T: 'Piper Turbo Arrow IV',
  ...
  PAY3: 'Piper Cheyenne III',

  // Beechcraft
  B36T: 'Beechcraft Bonanza 36TC',
  BE19: 'Beechcraft Sport 150',
  BE23: 'Beechcraft Musketeer / Sundowner',
  ...
  // Other light GA / LSA / motor gliders
  ...
  A22: 'Aeroprakt A-22 Foxbat',
  WT9: 'Aerospool WT9 Dynamic',
  ULAC: 'Ultralight',
  GLID: 'Glider',
  DG40: 'DG Flugzeugbau DG-400',
  DIMO: 'Diamond HK36 Super Dimona',
  ...
  ASTR: 'IAI Astra / Gulfstream G100',

  // Regional / airliner aliases seen in the wild
  E175: 'Embraer E175',
  ...
  H269: 'Schweizer 269 / Hughes 300',
  EN28: 'Enstrom F-28 / 280',
};
