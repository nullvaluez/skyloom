import { addOperationsMask } from './operations-scenery';
 ...
 */
export function airportSceneryMask(vt,size,trueTileSpan,wholeAirfield=false,frame=null){
  const layer=vt.layers.aeroway;if(!layer)return addOperationsMask(null,size,frame);
  ...
  return addOperationsMask(mask,size,frame);
}
