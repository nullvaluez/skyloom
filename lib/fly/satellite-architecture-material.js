...
`);
  ...
  material.customProgramCacheKey = () => `${bendKey}|cinematic-architecture-v3-${distant ? 'far-coverage' : 'near'}${immersive ? '|immersive-surface-v1' : ''}${groundLighting ? '|ground-window-v2' : ''}`;
