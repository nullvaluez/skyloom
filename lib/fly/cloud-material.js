...
vec3 r24CloudShade( vec3 col ) {
  ...
  // 3.14159…: this head is prepended BEFORE <common>, so three's PI macro is not
  // defined yet at this point in the file (R24 Fable post-merge audit).
  float hg = ( 1.0 - g * g ) / ( 4.0 * 3.141592653589793 * pow( denom, 1.5 ) );
