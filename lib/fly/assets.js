...
export const FLY_ASSETS = [
  {
    kind: 'model', name: 'Willis Tower (high detail v1)',
    file: 'public/models/monument-willis-detail-v1.glb',
    author: 'Skyloom contributors', source: 'First-party authored geometry',
    url: 'https://github.com/nullvaluez/skyloom', license: 'MIT',
    modifications: 'Original nine-tube architecture with vertical mullions and two rooftop masts; 3384 triangles, 337232 bytes. Indexed, normalized, vertex albedo and authored surface/lighting attributes.',
  },
  {
    kind: 'model',
    name: 'Eiffel Tower (high detail v1)',
    file: 'public/models/monument-eiffel-detail-v1.glb',
    author: 'Scott Marshall',
    source: 'Poly Pizza',
    url: 'https://poly.pizza/m/aIpJchqtRTg',
    license: 'CC-BY 3.0',
    modifications: 'Landmark detail v1: 56012 triangles, 3283220 bytes; normalized, degenerate triangles removed, vertex albedo and authored surface/lighting attributes. Footprint corrected to 125:330 aspect. Source texture baked offline.',
  },
  {
    kind: 'model',
    name: 'Eiffel Tower (medium detail v1)',
    file: 'public/models/monument-eiffel-medium-v1.glb',
    author: 'Skyloom contributors',
    source: 'First-party authored geometry',
    url: 'https://github.com/nullvaluez/skyloom',
    license: 'MIT',
    modifications: 'Landmark detail v1: 9000 triangles, 337484 bytes; normalized, degenerate triangles removed, vertex albedo and authored surface/lighting attributes. Original architectural approximation; no third-party model geometry.',
  },
  {
    kind: 'model',
    name: 'Empire State Building (high detail v1)',
    file: 'public/models/monument-empire-state-detail-v1.glb',
    author: 'Skyloom contributors',
    source: 'First-party authored geometry',
    url: 'https://github.com/nullvaluez/skyloom',
    license: 'MIT',
    modifications: 'Landmark detail v1: 3552 triangles, 354792 bytes; normalized, degenerate triangles removed, vertex albedo and authored surface/lighting attributes. Original architectural approximation; no third-party model geometry.',
  },
  {
    kind: 'model',
    name: 'CN Tower (far detail v1)',
    file: 'public/models/monument-cn-tower-far-v1.glb',
    author: 'Skyloom contributors',
    source: 'First-party authored geometry',
    url: 'https://github.com/nullvaluez/skyloom',
    license: 'MIT',
    modifications: 'Landmark detail v1: 568 triangles, 46964 bytes; normalized, degenerate triangles removed, vertex albedo and authored surface/lighting attributes. Original architectural approximation; no third-party model geometry.',
  },
  {
    kind: 'model',
    name: 'CN Tower (medium detail v1)',
    file: 'public/models/monument-cn-tower-medium-v1.glb',
    author: 'Skyloom contributors',
    source: 'First-party authored geometry',
    url: 'https://github.com/nullvaluez/skyloom',
    license: 'MIT',
    modifications: 'Landmark detail v1: 2424 triangles, 189904 bytes; normalized, degenerate triangles removed, vertex albedo and authored surface/lighting attributes. Original architectural approximation; no third-party model geometry.',
  },
  {
    kind: 'model',
    name: 'CN Tower (high detail v1)',
    file: 'public/models/monument-cn-tower-high-v1.glb',
    author: 'Skyloom contributors',
    source: 'First-party authored geometry',
    url: 'https://github.com/nullvaluez/skyloom',
    license: 'MIT',
  ...
  {
    kind: 'model',
    name: 'Burj Khalifa (far detail v1)',
    file: 'public/models/monument-burj-khalifa-far-v1.glb',
    author: 'Skyloom contributors',
    source: 'First-party authored geometry',
    url: 'https://github.com/nullvaluez/skyloom',
    license: 'MIT',
    modifications: 'Landmark detail v1: 1300 triangles, 114160 bytes; normalized, degenerate triangles removed, vertex albedo and authored surface/lighting attributes. Original architectural approximation; no third-party model geometry.',
  },
  {
    kind: 'model',
    name: 'Burj Khalifa (medium detail v1)',
    file: 'public/models/monument-burj-khalifa-medium-v1.glb',
    author: 'Skyloom contributors',
    source: 'First-party authored geometry',
    url: 'https://github.com/nullvaluez/skyloom',
    license: 'MIT',
    modifications: 'Landmark detail v1: 10836 triangles, 879216 bytes; normalized, degenerate triangles removed, vertex albedo and authored surface/lighting attributes. Original architectural approximation; no third-party model geometry.',
  },
  {
    kind: 'model',
    name: 'Burj Khalifa (high detail v1)',
    file: 'public/models/monument-burj-khalifa-high-v1.glb',
    author: 'Skyloom contributors',
    source: 'First-party authored geometry',
    url: 'https://github.com/nullvaluez/skyloom',
    license: 'MIT',
    modifications: 'Landmark detail v1: 27732 triangles, 2202220 bytes; normalized, degenerate triangles removed, vertex albedo and authored surface/lighting attributes. Original architectural approximation; no third-party model geometry.',
  },


  { kind:'data', name:'Living Earth regional context', file:'public/data/living-regions.json', author:'Natural Earth contributors', source:'Natural Earth 1:50m Admin 0 Countries', url:'https://www.naturalearthdata.com/about/terms-of-use/', license:'Public domain', modifications:'Retained country code, subregion and geometry. Used only for inferred architectural context; footprints and heights remain sourced from map data.' },
  { kind: 'audio', name: 'Immersive wind texture', file: 'public/audio/immersive/wind.ogg', author: 'IgnasD', source: 'OpenGameArt', url: 'https://opengameart.org/content/wind', license: 'CC0', modifications: 'Selected Wind.ogg; loop boundary crossfaded at runtime, filtered by cloud density and airspeed.' },
  { kind: 'audio', name: 'Immersive engine texture', file: 'public/audio/immersive/engine.mp3', author: 'pauliuw', source: 'OpenGameArt', url: 'https://opengameart.org/content/engine-sounds2', license: 'CC0', modifications: 'Renamed engine_sound.mp3; loop boundary crossfaded at runtime, pitch and filter follow airspeed.' },
  {
    kind: 'font',
    name: 'Archivo Black',
...
/** First-party material treatment; original model credits and baked albedo remain above.
 * Source maps are reused when present. These defaults never claim an authored texture.
 */
export const MODEL_SURFACE_ROLES = {
  paintedAircraft: { roughness: 0.36, metalness: 0.28, clearcoat: 0.45, clearcoatRoughness: 0.24, envMapIntensity: 0.7 },
  canopy: { roughness: 0.17, metalness: 0.12, clearcoat: 0.8, clearcoatRoughness: 0.12, envMapIntensity: 0.9 },
  stone: { roughness: 0.84, metalness: 0, envMapIntensity: 0.55 },
  iron: { roughness: 0.57, metalness: 0.55, envMapIntensity: 0.7 },
  steel: { roughness: 0.32, metalness: 0.82, envMapIntensity: 0.85 },
  glass: { roughness: 0.26, metalness: 0.34, envMapIntensity: 0.8 },
  copper: { roughness: 0.73, metalness: 0.38, envMapIntensity: 0.6 },
  ceramic: { roughness: 0.45, metalness: 0.05, envMapIntensity: 0.65 },
};

/** Rendering contracts, separate from each source asset's unchanged credits.
 * supportedSlots describes loader capability, NOT maps claimed to exist in a
 * particular file. No supplemental texture files or third-party masks are used.
 * A reused aircraft GLB can have both a source-PBR player representation and a
 * textureless, merged traffic representation; they must not share a map claim.
 */
export const MODEL_RENDERING_PROFILES = {
  player: {
    representation: 'source-pbr-materials',
    materialMaps: { policy: 'retain-supported-embedded-maps-if-present',
      supportedSlots: ['map', 'normalMap', 'roughnessMap', 'metalnessMap', 'aoMap', 'emissiveMap'],
      supplementalFiles: [] },
    materialRoles: ['paintedAircraft', 'canopy'],
    roleProvenance: 'first-party treatment; canopy selected from source material/name hints',
    lightingMask: { type: 'procedural-nav-strobe-and-rim', provenance: 'first-party',
      definition: 'components/fly/PlayerPlane.jsx', textureFiles: [] },
  },
  traffic: {
    representation: 'merged-baked-vertex-color',
    materialMaps: { policy: 'no-runtime-source-texture-sampling', usedSlots: [], supplementalFiles: [] },
    materialRoles: ['paintedAircraft'],
    roleProvenance: 'first-party shared hull treatment; source albedo remains baked in vertex color',
    lightingMask: { type: 'aEmissive', provenance: 'source emissive factors plus first-party navigation-light geometry',
      definition: 'lib/fly/model-loader.js', textureFiles: [] },
  },
  landmark: {
    representation: 'merged-baked-vertex-color',
    materialMaps: { policy: 'no-runtime-source-texture-sampling', usedSlots: [], supplementalFiles: [] },
    roleProvenance: 'first-party inferred surface treatment',
    lightingMask: { type: 'aModelLight', provenance: 'first-party-unit-height-radial-v1',
      definition: 'lib/fly/cinematic-models.js', accentDefinition: 'lib/fly/monument-models.js',
      textureFiles: [], observation: 'authored approximation, not a live lighting schedule' },
  },
};

const monumentRoles = {
  'monument-empire-state.glb': 'stone', 'monument-liberty.glb': 'copper',
  'monument-taj-mahal.glb': 'stone', 'monument-opera-house.glb': 'ceramic',
  'monument-colosseum.glb': 'stone', 'monument-big-ben.glb': 'stone',
  'monument-willis.glb': 'glass', 'monument-space-needle.glb': 'steel',
  'monument-gateway-arch.glb': 'steel',
};
for (const asset of FLY_ASSETS) {
  if (asset.kind !== 'model') continue;
  const file = asset.file.split('/').pop();
  if (file.startsWith('traffic-')) {
    asset.rendering = { traffic: MODEL_RENDERING_PROFILES.traffic };
    // The hangar reuses every mapped traffic GLB except the helicopter.
    if (file !== 'traffic-helicopter.glb') asset.rendering.player = MODEL_RENDERING_PROFILES.player;
  } else if (file === 'player-jet.glb') {
    asset.rendering = { player: MODEL_RENDERING_PROFILES.player };
  } else if (monumentRoles[file] || file.startsWith('monument-')) {
    asset.rendering = { landmark: { ...MODEL_RENDERING_PROFILES.landmark, materialRoles: [monumentRoles[file] ?? (file.includes('eiffel') ? 'iron' : file.includes('burj') ? 'glass' : 'stone')] } };
  }
}
