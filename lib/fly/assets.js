...
export const FLY_ASSETS = [
  ...
  },
  {
    ...
    license: 'CC-BY 3.0',
    modifications:
      'geometry merged + vertex colors baked at load; rescaled to real meters; nav-light octahedra appended (round 8); also reused (retinted) for the glider archetype',
  },
  {
    kind: 'model',
    name: 'Helicopter',
  ...
  },
  {
    ...
    license: 'CC-BY 3.0',
    modifications:
      'round 14: downloaded as published (no geometry edits on disk); geometry merged + vertex colors baked at load; rescaled to real meters; nav-light octahedra appended — warbird-jet archetype',
  },
  {
    kind: 'model',
 ...
 * abstract shapes; the three R14 primitives are purpose-built silhouettes —
 * no license-clean GLB matched the era, only warbird-jet got a real model).
...
export const TRAFFIC_MODELS = [
  ...
  null, // warbird-prop — purpose-built primitive (low-wing fighter silhouette)
  ...
  null, // warbird-heavy — purpose-built primitive (4-engine straight-wing heavy)
  null, // classic-transport — purpose-built primitive (twin-nacelle DC-3 planform)
];
