...
export const GROUND_LIGHTING = {
  ...
  heightRangeM: 256,
  receiverGain: 1.4,
  // Street gain is glow * (1 + lampGain * gaussian): dim the continuous
  // ribbon while retaining a 0.036 lamp center and the existing pool width.
  // Matched Melton review: surface spill and pole emitters carry the light;
  // a brighter self-lit ribbon still reads as rectangular copper striping.
  road: { glow: 0.004, lampGain: 8, lampSharp: 125, streamGain: 0.018, trafficGain: 0.24 },
};
