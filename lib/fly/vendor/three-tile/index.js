...
// R24 D PATCH 3 (LOD_CROSSFADE) — the crossfade hook holder.
...
class T extends oe {
  ...
  async _loadSubTiles(e) {
    ...
    // R24 D PATCH 1 (LOD_CROSSFADE) — parent-retained crossfade on REFINE.
  ...
  async _removeSubTiles(e) {
    ...
    // R24 D PATCH 2 (LOD_CROSSFADE) — the SAME crossfade run backwards on a
...
export {
  ...
  lt as strTemplate,
  $e as tileBoundsClip,
  // R24 D PATCH 3 (LOD_CROSSFADE) — the hook installer (lib/fly/terrain-engine.js
  // is its only caller; see VENDOR.md row D3).
