 ...
 *   - the key is min·K + max with max < K, so ascending numeric key order IS
 ...
 *     for every input it does not claim: a non-multiple-of-3 index array, an
 *     index >= K, a third occurrence of one undirected edge (non-manifold), or
