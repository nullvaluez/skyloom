...
// ---------------------------------------------------------------------------
const SIZES = {
  aBuildingStyle: 3, aWaterShore: 3, aModelSurface: 2, aModelLight: 3, aCanopyPhase: 1, aHomeVariant: 1,
  normal: 3,
  uv: 2,
  color: 3,
  aFoam: 1,
...
function buildWarmScene() {
  ...
  if (satelliteVisualsOn()) {
    ...
    add(tri(['normal','color','aAnchor','aModelSurface','aModelLight']), createCinematicModelMaterial(applyBendAnchorMonument, {merged:true}));
