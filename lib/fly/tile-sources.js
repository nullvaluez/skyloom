...
export function createTerrainSources(style = 'satellite', tier = null) {
  ...
  // (D W1: hand-applied onto the VENDORED import line — E branched before A's
  // vendor landed, so a `git checkout r24/e -- lib/fly/tile-sources.js` would
  // have reverted A. Same text, one hunk; flagged to Fable as a merge note.)
