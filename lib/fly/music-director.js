...
export class MusicDirector {
  ...
  update(s, nowSec) {
    ...
    this._pulseRate = rate; // verify-juice reads this through __flyStats.juice
  ...
  /** Notes/sec the speed pulse is scheduling — 0 means the layer is closed. */
  get pulseRate() {
    return this._pulseRate ?? 0;
  }
