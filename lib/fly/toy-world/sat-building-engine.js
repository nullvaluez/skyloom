...
export class SatBuildingEngine {
  constructor({ groundAt }) {
    ...
    this._stat = { errorRetries: 0, evictions: 0, heals: 0, degenerateDropped: 0, healsInPlace: 0, healsNoop: 0, healsQueueFull: 0, healsAborted: 0, healsNoRecord: 0, healsCoalesced: 0, fadeBudgetMiss: 0 };
