...
import { GLOBE, SAT_BLDG_FADE, SAT_BUILDINGS, SAT_SKYLINE, STREAM_KEEPER } from '../fly-constants';
  ...
  _finalizePending(nowSec = 0) {
    ...
    for (let i = 0; i < this.pendingFinalize.length && done < SK.finalizePerFrame; i++) {
      ...
      if (geo.boundingSphere)
        geo.boundingSphere.radius += bendMarginM(SK.ring.r, (gspan * Math.SQRT2) / 2);
