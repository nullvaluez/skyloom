...
import { BEND_LEAD, GLOBE, SAT_BLDG_FADE, SAT_BUILDINGS, SAT_SKYLINE, STREAM_KEEPER } from '../fly-constants';
...
export class SatSkylineEngine {
  constructor({ groundAt }) {
    ...
    this._stat = { errorRetries: 0, evictions: 0, heals: 0, degenerateDropped: 0 };
