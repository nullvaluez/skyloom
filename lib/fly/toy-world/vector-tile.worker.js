...
import { BEACONS, ROOFS, RUNWAY_LIGHTS, TOY_WORLD } from '../fly-constants';
...
// accepted `detail` vocabulary (round 12: 'ultra' — a stale worker would
// silently run a z10 tile through the FULL filters).
const WORKER_PROTOCOL = 9;
...
const api = {
   ...
   * features (minor roads, taxiways, canals) at the source.
