...
export const PALETTE = {
  ...
  //
  // Round 18 nudge (Fable, user-sanctioned; VALUE/WARMTH ONLY, hue family
  // untouched — the R13 taste lock): the six body slates sat within ~4 luma
  // points of each other, so every block read as one navy mass. Same six
  // hues, value-spread widened (×0.84…×1.22, mean ≈ ×1.0) so neighbours
  // separate; base AO lifted off true black; tops warmed a step toward
  // sodium so the roof plane stops reading icy. One-commit revert restores
  // the R17 values preserved here:
  //   buildings: ['#1b2036', '#1f2440', '#171b2e', '#232946', '#1d2239', '#191e33']
  //   buildingShade: '#080a14'   buildingTop: '#93a5d6'
  buildings: ['#181d31', '#232848', '#131727', '#2b3255', '#1e233a', '#181c30'],
  buildingShade: '#0b0e1b',
  ...
  buildingTop: '#a3accc', // round 18 nudge: warmed (was #93a5d6 — see block note)
