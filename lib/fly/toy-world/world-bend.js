...
/**
 * Style-change-time (NOT per frame): round-8 depth haze — distant ground
 * recedes toward a cool haze tone across [startM, endM] BEFORE the rim
 * fade. Pass max 0 to disable (every style but toy). endM must sit UNDER
 * the style's fade start so the rim gates hold (toy: 13km < 14km).
 */
