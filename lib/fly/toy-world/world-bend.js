 ...
 *   hill token 'd'          (A GROUND, GROUND_DETAIL_R25.overlay) — the fifth
 *                            token on hillKey, in fixed order after R24's
 *                            'e' 'f' 'a' 'l': the procedural detail overlay
 *                            (fine luma grain + analytic normal perturbation,
 *                            imagery-classed) inside the hillshade patch.
 ...
 *   'world-bend-anchor-scrub-r25' (A GROUND, conditional) — ONLY if the scrub
 *                            cards gain a per-instance sway attribute; without
 *                            it they share 'world-bend-anchor-r8' verbatim.
