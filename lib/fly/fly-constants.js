...
/**
 * B CITY-LIGHT — the enhancement pass (plan §4B: road-life night envelope,
 * window variance/dark floors, bloom night tune, tier proposal). Ships
 * enabled:false until the Fable flip after review; flag-off byte-identity
 * is the revert contract.
 */
export const NIGHT_CITY_R23 = {
  enabled: false, // Fable W2 flip decision (plan §6)
};
