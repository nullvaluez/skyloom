...
export const VISUALS = {
  key: 'fly-visuals',
  // R25 E ship state (intro pass, 2026-09-24): the Visuals-default rule — the
  // default stays 'enhanced' only if an Enhanced visual sub-flag ships ON.
  // The intro pass ships R25_SKY and R25_GROUND OFF, so the default is
  // 'classic' (behaviour is identical either way while visualsAvailable() is
  // false: resolveInitialVisuals forces 'classic' and the Settings row is
  // hidden). THE VISUALS PASS REVISITS THIS: set it back to 'enhanced' (the
  // user's decision, "Default Enhanced") when a C/D Enhanced sub-flag ships ON.
