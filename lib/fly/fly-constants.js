...
export const LETTERS = {
  ...
  landmark: { sizeM: 100, rangeM: 60000, max: 2 },
  military: { sizeM: 130, rangeM: 95000, max: 3 },
  hotspot: { sizeM: 95, rangeM: 55000, max: 2 },
  minDistM: 2200, // suppress a letter when practically overhead
  ...
  // their two radii collide (bigger kind wins). Cities pack tight so a metro's
  // suburbs coexist (the whole point of the round-10 expansion); landmarks keep
  // the round-6 4500 so dense clusters (NYC monuments) stay slot-stable and
  // don't churn — a global 3000 blinked EMPIRE STATE in/out (verify-poi).
  separationM: { city: 3000, airport: 3600, military: 4200, landmark: 4500, hotspot: 4200 },
...
export const TOWN_GLOW = {
  ...
  maxRangeM: 30000, // beyond this the rim fade has eaten the world anyway
  opacity: 0.35,
...
export const TILES = {
  satMaxZoom: 17, // round 7: deeper Esri imagery for low passes (was 16)
