...
export const LOD_CROSSFADE = {
  ...
  //      the LOD refines, only whether the swap is blended)
  //   2  hardSwaps DROPS toward 0; faded RISES
  //   3  active === 0 AND retained === 0 after >= 10 rendered frames of settle
  //      (retained > 0 at rest is a texture leak — the best catch here)
  //   4  0 < peakActive <= 32
