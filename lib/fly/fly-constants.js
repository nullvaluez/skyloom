...
export const LINEAR_HAZE = { enabled: false };
/**
...
export const ONE_SUN = {
   ...
   */
  hill: { dayDeg: 40, dayK: 0.65, lowDeg: 15 },
  /**
 ...
 */
export const POST_ORDER = { enabled: false, smaaPreset: 'high', dither: true };
/**
 ...
 */
export const DEPTH_FIX = { enabled: false };
/**
 ...
 */
export const LAMBERT_ENV = { enabled: false, reflectivity: 0.15 };
