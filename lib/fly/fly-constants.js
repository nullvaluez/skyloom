...
export const LOD_CROSSFADE = {
  ...
  //   3  active === 0 AND retained === 0, reached by POLLING TO THE CONDITION
  //      with a frame cap — NOT a fixed frame count. A drain must cover
  ...
  //      frames here, 54 at 60 fps, ~130 at 144 Hz — poll until skip.warp
  //      stops advancing instead of counting.
  //   4  0 < peakActive <= 32
