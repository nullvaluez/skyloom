...
/** D: single analytic aerial-perspective law shared by the post pass and the per-material term (recon L4). */
export const AERIAL_LAW = { enabled: false };
/** D: parent→child tile crossfade so LOD refines never hard-pop (recon T4). */
export const LOD_CROSSFADE = { enabled: false, fadeSec: 0.25 };
