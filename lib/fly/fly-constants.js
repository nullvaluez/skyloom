...
export const ROOF_TYPOLOGY = {
  ...
  bands: [
    { maxAreaM2: 600, hM: [6, 9], form: 'house' },
    { maxAreaM2: 2500, aspectMin: 3, hM: [6, 8], form: 'strip' },
    { maxAreaM2: 2500, hM: [7, 12], form: 'school' },
    { maxAreaM2: 10000, hM: [8, 14], form: 'bigbox' },
    { maxAreaM2: Infinity, hM: [10, 16], form: 'warehouse' },
  ],
...
export const SAT_FAR_SUBURB = {
  ...
  hardCapM: 25, // absolute ceiling — NOTHING invented may exceed this
...
export const OVERCAST_V2 = {
  enabled: false,
  horizonKeep: 0.35, // fraction of the pre-lid horizon color kept at the rim
  zenithRamp: 0.6, // lid darkening toward zenith (real ceilings are dimmest overhead)
  duskChroma: 0.25, // residual warm chroma admitted through the lid at dusk
};
...
export const SAT_GROUND_LIFE = {
  enabled: false,
  areaPerTreeM2: { residential: 3500, farmland: 8000, orchard: 1800 },
  houseAvoidM: 14,
...
export const SUBURB_NIGHT = {
  enabled: false,
  houseLights: {
    litFrac: 0.35, // fraction of housePts lit (hash-stable per anchor)
    pool: 600,
    sizeM: 7,
    color: '#ffd9a0',
    dayFrac: 0.3,
  ...
  streetGain: { c5: 0.5, c6: 0.35 }, // envelope weights for cls 5–6
};
...
export const CINEMA_FIX = {
  enabled: false,
  maxRangeM: 900, // rangeM = clamp(sep * rangeK, 120, this)
  engageMaxM: 8000, // beyond this, C falls back to chase
};
 ...
 * ~15 s). For holdSec after a warpEpoch bump, vy is softly servoed toward
 * the warp's altM unless the player pitches (input cancels instantly). The
 * verify-feel OUTCOME gate is the contract: warp to 2300 m at cruise,
 * hands-off 30 s ⇒ altitude within ±toleranceM.
 */
...
export const NEON_COVER = {
  enabled: false,
  maxFeaturesPerLayer: 400, // per tile, per polygonPass layer
  minAreaM2: 120, // sub-pixel at toy altitudes — dropped pre-earcut
  select: { volumeStratified: true }, // building pick mirrors ROOFS_SAT.select
};
