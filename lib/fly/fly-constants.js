...
export const VISUALS = {
  key: 'fly-visuals',
  // R25 visuals resume (2026-09-24): Enhanced is available for review.
  // Keep Classic as the default until the appearance gates are certified;
  // runtime/GPU checks alone do not fulfill the planned Default Enhanced gate.
  // Supported flags, evidence and remaining work: CLEAR_SKY_VISUALS.md.
...
export const R25_SKY = {
  ...
  exposure: { enabled: true, biasStops: -0.06 },
}; // owner C
...
export const R25_GROUND = {
  ...
  oneSun: { enabled: true, lo: 0.6, hi: 1.45, a: 0.2, fullStrength: 0.55, groundValueK: 1.035 },
  ...
  // Deferred: the shipped shadow/earth material already uses 15 fragment
  // samplers on WebGL2. Relief uses the 16th; a separate colour atlas makes
  // the program fail to link. Pack the two into one sampler before enabling.
  colorRef: { enabled: false, zoom: 11, slotPx: 64, atlasPx: 512, clampLo: 0.5, clampHi: 2, edgeFadeTiles: 0.5, maxFetches: 4 },
  sharpen: { enabled: true, minTier: 'high', k: 0.3 },
  retireQuilt: { enabled: false },
  ...
  budget: { enhancedTerrainResidentMiB: null },
}; // owner D
