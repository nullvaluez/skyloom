...
export const LOD_CROSSFADE = {
  enabled: false,
  // The blend window, in SIMULATION seconds. FlyScene's -50 block clamps its
  // dt at 50 ms, so this is 0.25 s of UN-HITCHED frame time: at 60 fps it is
  // 250 ms wall and 15 frames; through a hitch it stretches in wall time but
  // never drops below 5 rendered frames. A crossfade wants a frame count, not
  // a wall duration — a "250 ms" fade that renders twice is a two-step pop.
