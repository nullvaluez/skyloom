 ...
 * MOBILE_UI.infoChip.dockBottomRem for the shorter column (anchor 3.25 + rail
 * 8.25 + 0.75 + boost 4.25 + 0.75 + FAB 3.5 = 20.75 rem, + 1). Reduced motion
...
export const MOBILE_FAN_R25 = {
  ...
  ringGapPx: 8, // second ring offset for petals beyond the first arc
