 ...
 */
// W1 DISCIPLINE: this block stays enabled:false until the close, where Fable
// flips the Level A blocks ON in ONE integration commit — E calibrates every
// new gate RED on the LITERAL flag-off tree. RECOMMENDED ON AT CLOSE (see
// scripts/r24-b-world.md §1: RED 14.22% / 14.84% coincident-degenerate on the
// closed-ring node fixture, GREEN 0, normals bit-identical, same-object-when-
// clean). Once it is on, `__flyFlashPin='off'` is the same-session RED leg.
export const FLASH_GUARD = { enabled: false, minArea2: 0 };
/**
 ...
 */
export const BEND_LEAD = { enabled: false, poolLeadM: 1500 };
/**
 ...
 */
export const GROUND_VIS = { enabled: false, maxStepM: 4 };
