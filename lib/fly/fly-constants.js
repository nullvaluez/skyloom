 ...
 */
export const FX_STABILITY = { enabled: false };
...
export const PREWARM = {
  ...
  warmEffectsAltTier: true, // also warm the alternate tier's merged EffectPass
...
export const STREAM_KEEPER = {
  ...
  parkVeg: true,
  waterInPlace: true,
  skylineHysteresis: { evictM: 10500, rearmM: 9200, visReevalM: 150, visReevalSec: 1 },
  stagedRingShift: { stepM: 1000 }, // toy ultra full-ring shrink, per refresh
  lookahead: { leadSec: 2.5, maxLeadFrac: 0.35 }, // velocity-led ring center
...
export const SURFACE_CALM = {
  ...
  parcel: {
    ...
    regKTau: 3, // regK EMA time constant (s)
    regKDeadband: 0.15, // |ΔregK| below this: no re-place
  ...
  uploads: { ranges: true, stagger: [0, 0.25, 0.5, 0.75] }, // ×2 s cadence phases
  depthOffsetFix: true,
  duskCalm: { intraPairDip: 0, seedFromScene: true },
};
...
export const TILE_PIPELINE = {
  ...
  skylineShuffle: { anchorCount: 60 }, // top-N by volume always survive
