...
export const SAT_BUILDINGS = {
  ...
  wallTones: ['#8f8b82', '#83807a', '#98948a', '#7c7f83', '#8a867d', '#909499'],
  roofMul: 0.82, // roofs a shade darker (tar/gravel) than the walls
};
...
export const CLOUDS = {
  ...
  // clouds at 1800m stay f = 1).
  altSpread: { enabled: true, maxF: 3.2, sizeExp: 0.6, satEnabled: true, satStartAglM: 4000, satPerAglM: 4000 },
