...
export const MOBILE_UI = {
  ...
  infoChip: {
    ...
    //   armed, bottom-up: anchor 3.25 + BOOST 2.75 + gap 0.75 + rail 8.25 +
    //   gap 0.75 + FAB 3.5 = 19.25 rem  (MEASURED: column top 308 px above the
    //   bottom of a 844 px screen, i.e. 19.25 rem exactly).
    ...
    // SwiftShader measurement, the extra 1.5 rem is kept as headroom: it is the
    // conservative direction (the chip sits higher, never lower), and every
    // disjointness gate passes with it.
 ...
 * 2.75 + 0.75 + rail 8.25 + 0.75 + FAB 3.5 = 19.25 rem MEASURED; 21.75 keeps
