...
export const VISUALS = {
  key: 'fly-visuals',
  // R25 release (2026-09-24): user approved Enhanced as the default.
  // Explicit saved Classic preferences still win. Appearance follow-ups and
  // measured runtime limits remain documented in CLEAR_SKY_VISUALS.md.
