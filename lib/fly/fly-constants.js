...
/* ============================== ROUND 23 =================================
 * "Night Alive" — pre-seeded by Fable at plan time (FLY_ROUND23_PLAN.md),
 * the R18–R22 zero-merge-conflict idiom: each agent fills knobs ONLY inside
 * its own block. C (cert) owns neither block and touches neither.
 * ========================================================================= */

/**
 * A NIGHT-TRUTH — root-cause fixes for the R21→R22 satellite night
 * regression (plan §2 H1–H6, §4A). Pure mechanism repairs restoring the
 * R21-certified read may ship un-flagged (documented per fix in
 * R23_A_ROOTCAUSE.md); anything with taste/perf surface hangs here.
 */
export const NIGHT_TRUTH_R23 = {
  enabled: false, // A flips per-fix knobs inside; Fable rules the final state
};
