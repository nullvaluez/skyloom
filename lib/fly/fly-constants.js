...
export const FRONT_DOOR = {
  ...
  bootCompact: true,
  exitToTitle: true,
  orbit: { periodSec: 240, reducedMotionPeriodSec: 900, radiusM: 2600, aglM: 900, minAglM: 350, fovDeg: 52, easeSec: 2.5 },
}; // owner A

/** A: the Visuals Enhanced/Classic profile (persisted key; default applies only when an R25 visual block ships ON). */
export const VISUALS = { key: 'fly-visuals', defaultProfile: 'enhanced' }; // owner A
