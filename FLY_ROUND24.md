...
39. **The constants an instrument DECLARES must be the ones it measured, and a
...
| `CHUNK_FADE` | pops 92 → 2, both attributable; `maxDying` 4 is the only draw term. **ON per the ship table; green leg PENDING ATTRIBUTION** — pass 2b's fade row saw 29 of 29 hard births with the presence channel reading `'none'` (§4.2) | **ON**, merged `7face8f` |
