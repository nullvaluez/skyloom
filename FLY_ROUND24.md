...
which `verify-import-integrity` could not see because it does not sweep
`scripts/`; E is extending it with this as its RED) (the tenth, pass 2b's pale self-test registering 0 hits live where the
...
44. **The constants an instrument DECLARES must be the ones it measured, and a
