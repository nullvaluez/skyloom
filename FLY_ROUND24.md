...
- ~~8 genuine refetches on a pure yaw~~ **ATTRIBUTED** (A, §22 as corrected by
  ...
  built this round for want of a measurement budget** (§4.2). With it, E's
  instrument fix: **dump the classified duplicate LIST — kind, z, url, count,
  bucket — instead of a count and two examples.**
