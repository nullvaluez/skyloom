...
89. **A validity test that a DEGENERATE value passes honestly needs a
    ...
    continuous SURFACE, and **one corrector cannot serve both**. (C LIGHT; pairs
    with 86.)
