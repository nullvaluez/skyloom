...
39. **A time-only ramp is a frame-rate assumption — floor every ramp in FRAMES
    ...
    entirely. (B WORLD.)
40. **The constants an instrument DECLARES must be the ones it measured, and a
