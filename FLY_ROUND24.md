...
**E's instrument-defect count for the session is ELEVEN**, each with a defence in
...
handle B published for it — §4.2): the context race; the artifact overwrite (§5.4); the straw-man port
