...
Dry tree after all the held tips: node smoke **16/16**, import-integrity **4/4**,
and `attr-proof` **RED at 80 as expected**, before A's fix.
...
56. **The constants an instrument DECLARES must be the ones it measured, and a
