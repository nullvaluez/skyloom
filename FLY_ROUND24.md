...
51. **A no-page-errors gate must print the STACK, not just the message.** One
    ...
    reported the text alone; E now prints the first three UNIQUE exceptions with
    their stacks. (E CERT.)
...
54. **An un-asserted CONTAINER SWAP is the same defect family as an un-asserted
    ...
    lesson 16.)
55. **The constants an instrument DECLARES must be the ones it measured, and a
