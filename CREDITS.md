...
- **Jet (military)** (model) — Poly by Google, poly.pizza · [CC-BY 3.0](https://poly.pizza/m/dukcCKsLDrS) · modifications: geometry merged + vertex colors baked at load; rescaled to real meters; nav-light octahedra appended (round 8)
- **Boeing 747** (model) — Miha Lunar, poly.pizza · [CC-BY 3.0](https://poly.pizza/m/49CLof4tP2V) · modifications: geometry merged + vertex colors baked at load; rescaled to real meters; nav-light octahedra appended (round 8)
- **Small Airplane** (model) — Vojtěch Balák, poly.pizza · [CC-BY 3.0](https://poly.pizza/m/7cvx6ex-xfL) · modifications: geometry merged + vertex colors baked at load; rescaled to real meters; nav-light octahedra appended (round 8); also reused (retinted) for the glider archetype
...
- **Jet (player aircraft, fighter)** (model) — jeremy, poly.pizza · [CC-BY 3.0](https://poly.pizza/m/6fyLMORhgGK) · modifications: reoriented + rescaled at load; canopy material swapped for a glossy one on the mounted clone (round 8)
- **Kloofendal 48d Partly Cloudy (Pure Sky)** (hdri) — Greg Zaal, Poly Haven · [CC0](https://polyhaven.com/a/kloofendal_48d_partly_cloudy_puresky) · modifications: none (2K .hdr as published)
- **Clouds with Transparency** (texture) — WickedInsignia, OpenGameArt · [CC0](https://opengameart.org/content/clouds-with-transparency) · modifications: downscaled to 512px; RGB flattened to white (alpha carries the shape)
