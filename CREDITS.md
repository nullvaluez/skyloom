...
- **Low poly Fighter (warbird jet)** (model) — Stephen Graybill, poly.pizza · [CC-BY 3.0](https://poly.pizza/m/1fi8ZIDdFCP) · modifications: round 14: downloaded as published (no geometry edits on disk); geometry merged + vertex colors baked at load; rescaled to real meters; nav-light octahedra appended — warbird-jet archetype
