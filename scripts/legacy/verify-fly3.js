// LEGACY (R9-3, 2026-07-18): phase-3 floating-origin harness for the deleted flat-app boot flow; rebases/contrails now covered by verify-globe2. Kept unmigrated for the record — do not run against the fly-only app.
/**
