// LEGACY (R9-3, 2026-07-18): phase-5/6 gameplay+UI harness including the deleted exit-to-tracker flow; superseded by verify-fly-game/verify-chase-cam. Kept unmigrated for the record — do not run against the fly-only app.
/**
