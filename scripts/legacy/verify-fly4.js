// LEGACY (R9-3, 2026-07-18): phase-4 live-traffic harness against the deleted flat-app shell and its <300 draw budget; superseded by verify-tracers/verify-fleet. Kept unmigrated for the record — do not run against the fly-only app.
/**
