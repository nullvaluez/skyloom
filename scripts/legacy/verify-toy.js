// LEGACY (R9-3, 2026-07-18): early Toy World raster check (counts CARTO voyager tiles the vector toy world no longer requests). Kept unmigrated for the record — do not run against the fly-only app.
