...
const out=args.output||'.graphics-review/immersive-smoke';fs.mkdirSync(out,{recursive:true});
...
(async()=>{
 ...
 try{
  ...
  await page.goto(`${args.url||'http://localhost:3020'}/?graphics=immersive&graphicsReview=1`,{waitUntil:'domcontentloaded'});
